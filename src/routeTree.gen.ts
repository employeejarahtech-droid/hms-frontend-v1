...
const AuthenticatedCreateInvoiceIndexRoute =
  AuthenticatedCreateInvoiceIndexRouteImport.update({
    id: '/create-invoice/',
    path: '/create-invoice/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/create-invoice/': {
      ...
      preLoaderRoute: typeof AuthenticatedCreateInvoiceIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/chats/': {
